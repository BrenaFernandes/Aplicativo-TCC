...
public class EscolherEquiCliente extends javax.swing.JFrame {
    public EscolherEquiCliente() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Por favor, informe o contrato do cliente a ser removido:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String equipamento = (String) cbEqui.getSelectedItem();
        Cliente c = new Cliente();
        ClienteDAO DAO = new ClienteDAO();
        c.setTransformador(equipamento);//colocar o objeto do cb aqui
        c.setContrato(txtCliente.getText());
        DAO.delete(c);
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EscolherEquiCliente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EscolherEquiCliente().setVisible(true);
            }
        });
    }
